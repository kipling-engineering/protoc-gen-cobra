...
type Sound2 struct {
	...
	Timestamp         *timestamp.Timestamp    `protobuf:"bytes,51,opt,name=timestamp" json:"timestamp,omitempty"`
	Duration          *duration.Duration      `protobuf:"bytes,52,opt,name=duration" json:"duration,omitempty"`
	WrapperBool       *wrappers.BoolValue     `protobuf:"bytes,53,opt,name=wrapper_bool,json=wrapperBool" json:"wrapper_bool,omitempty"`
	WrapperBytes      *wrappers.BytesValue    `protobuf:"bytes,54,opt,name=wrapper_bytes,json=wrapperBytes" json:"wrapper_bytes,omitempty"`
	WrapperDouble     *wrappers.DoubleValue   `protobuf:"bytes,55,opt,name=wrapper_double,json=wrapperDouble" json:"wrapper_double,omitempty"`
	WrapperFloat      *wrappers.FloatValue    `protobuf:"bytes,56,opt,name=wrapper_float,json=wrapperFloat" json:"wrapper_float,omitempty"`
	WrapperInt32      *wrappers.Int32Value    `protobuf:"bytes,57,opt,name=wrapper_int32,json=wrapperInt32" json:"wrapper_int32,omitempty"`
	WrapperInt64      *wrappers.Int64Value    `protobuf:"bytes,58,opt,name=wrapper_int64,json=wrapperInt64" json:"wrapper_int64,omitempty"`
	WrapperString     *wrappers.StringValue   `protobuf:"bytes,59,opt,name=wrapper_string,json=wrapperString" json:"wrapper_string,omitempty"`
	WrapperUint32     *wrappers.UInt32Value   `protobuf:"bytes,60,opt,name=wrapper_uint32,json=wrapperUint32" json:"wrapper_uint32,omitempty"`
	WrapperUint64     *wrappers.UInt64Value   `protobuf:"bytes,61,opt,name=wrapper_uint64,json=wrapperUint64" json:"wrapper_uint64,omitempty"`
	ListTimestamp     []*timestamp.Timestamp  `protobuf:"bytes,71,rep,name=list_timestamp,json=listTimestamp" json:"list_timestamp,omitempty"`
	ListDuration      []*duration.Duration    `protobuf:"bytes,72,rep,name=list_duration,json=listDuration" json:"list_duration,omitempty"`
	ListWrapperBool   []*wrappers.BoolValue   `protobuf:"bytes,73,rep,name=list_wrapper_bool,json=listWrapperBool" json:"list_wrapper_bool,omitempty"`
	ListWrapperBytes  []*wrappers.BytesValue  `protobuf:"bytes,74,rep,name=list_wrapper_bytes,json=listWrapperBytes" json:"list_wrapper_bytes,omitempty"`
	ListWrapperDouble []*wrappers.DoubleValue `protobuf:"bytes,75,rep,name=list_wrapper_double,json=listWrapperDouble" json:"list_wrapper_double,omitempty"`
	ListWrapperFloat  []*wrappers.FloatValue  `protobuf:"bytes,76,rep,name=list_wrapper_float,json=listWrapperFloat" json:"list_wrapper_float,omitempty"`
	ListWrapperInt32  []*wrappers.Int32Value  `protobuf:"bytes,77,rep,name=list_wrapper_int32,json=listWrapperInt32" json:"list_wrapper_int32,omitempty"`
	ListWrapperInt64  []*wrappers.Int64Value  `protobuf:"bytes,78,rep,name=list_wrapper_int64,json=listWrapperInt64" json:"list_wrapper_int64,omitempty"`
	ListWrapperString []*wrappers.StringValue `protobuf:"bytes,79,rep,name=list_wrapper_string,json=listWrapperString" json:"list_wrapper_string,omitempty"`
	ListWrapperUint32 []*wrappers.UInt32Value `protobuf:"bytes,80,rep,name=list_wrapper_uint32,json=listWrapperUint32" json:"list_wrapper_uint32,omitempty"`
	ListWrapperUint64 []*wrappers.UInt64Value `protobuf:"bytes,81,rep,name=list_wrapper_uint64,json=listWrapperUint64" json:"list_wrapper_uint64,omitempty"`
}
...
func (x *Sound2) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *Sound2) GetDuration() *duration.Duration {
	if x != nil {
		return x.Duration
	}
	return nil
...
func (x *Sound2) GetWrapperBool() *wrappers.BoolValue {
	if x != nil {
...
func (x *Sound2) GetWrapperBytes() *wrappers.BytesValue {
	if x != nil {
...
func (x *Sound2) GetWrapperDouble() *wrappers.DoubleValue {
	if x != nil {
...
func (x *Sound2) GetWrapperFloat() *wrappers.FloatValue {
	if x != nil {
...
func (x *Sound2) GetWrapperInt32() *wrappers.Int32Value {
	if x != nil {
...
func (x *Sound2) GetWrapperInt64() *wrappers.Int64Value {
	if x != nil {
...
func (x *Sound2) GetWrapperString() *wrappers.StringValue {
	if x != nil {
...
func (x *Sound2) GetWrapperUint32() *wrappers.UInt32Value {
	if x != nil {
...
func (x *Sound2) GetWrapperUint64() *wrappers.UInt64Value {
	if x != nil {
...
func (x *Sound2) GetListTimestamp() []*timestamp.Timestamp {
	if x != nil {
...
func (x *Sound2) GetListDuration() []*duration.Duration {
	if x != nil {
...
func (x *Sound2) GetListWrapperBool() []*wrappers.BoolValue {
	if x != nil {
...
func (x *Sound2) GetListWrapperBytes() []*wrappers.BytesValue {
	if x != nil {
...
func (x *Sound2) GetListWrapperDouble() []*wrappers.DoubleValue {
	if x != nil {
...
func (x *Sound2) GetListWrapperFloat() []*wrappers.FloatValue {
	if x != nil {
...
func (x *Sound2) GetListWrapperInt32() []*wrappers.Int32Value {
	if x != nil {
...
func (x *Sound2) GetListWrapperInt64() []*wrappers.Int64Value {
	if x != nil {
...
func (x *Sound2) GetListWrapperString() []*wrappers.StringValue {
	if x != nil {
...
func (x *Sound2) GetListWrapperUint32() []*wrappers.UInt32Value {
	if x != nil {
...
func (x *Sound2) GetListWrapperUint64() []*wrappers.UInt64Value {
	if x != nil {
...
var file_proto2_proto_goTypes = []interface{}{
	...
	(*wrappers.FloatValue)(nil),  // 9: google.protobuf.FloatValue
