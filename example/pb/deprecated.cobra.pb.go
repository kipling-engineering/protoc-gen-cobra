...
var DeprecatedClientDefaultConfig = &_DeprecatedClientConfig{
...
func DeprecatedClientCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:        "deprecated",
	...
	DeprecatedClientDefaultConfig.addFlags(cmd.PersistentFlags())
	cmd.AddCommand(
		_DeprecatedObsoleteCommand(),
	)
	return cmd
}

func _DeprecatedDial(ctx context.Context) (*grpc.ClientConn, DeprecatedClient, error) {
	...
	return conn, NewDeprecatedClient(conn), nil
}

type _DeprecatedRoundTripFunc func(cli DeprecatedClient, in iocodec.Decoder, out iocodec.Encoder) error
