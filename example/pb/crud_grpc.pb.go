...
const (
	CRUD_Create_FullMethodName = "/example.CRUD/Create"
	CRUD_Get_FullMethodName    = "/example.CRUD/Get"
	CRUD_Update_FullMethodName = "/example.CRUD/Update"
	CRUD_Delete_FullMethodName = "/example.CRUD/Delete"
)
...
func (c *cRUDClient) Get(ctx context.Context, in *GetCRUD, opts ...grpc.CallOption) (*CRUDObject, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CRUDObject)
	err := c.cc.Invoke(ctx, CRUD_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
