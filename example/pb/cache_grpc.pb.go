...
type CacheClient interface {
	...
	MultiSet(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SetRequest, SetResponse], error)
	MultiGet(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GetRequest, GetResponse], error)
}
...
func (c *cacheClient) MultiSet(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SetRequest, SetResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Cache_ServiceDesc.Streams[0], Cache_MultiSet_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type Cache_MultiSetClient = grpc.ClientStreamingClient[SetRequest, SetResponse]

func (c *cacheClient) MultiGet(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GetRequest, GetResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Cache_ServiceDesc.Streams[1], Cache_MultiGet_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Cache_MultiGetClient = grpc.BidiStreamingClient[GetRequest, GetResponse]
...
type CacheServer interface {
	...
	MultiSet(grpc.ClientStreamingServer[SetRequest, SetResponse]) error
	MultiGet(grpc.BidiStreamingServer[GetRequest, GetResponse]) error
...
func (UnimplementedCacheServer) MultiSet(grpc.ClientStreamingServer[SetRequest, SetResponse]) error {
	return status.Errorf(codes.Unimplemented, "method MultiSet not implemented")
}
func (UnimplementedCacheServer) MultiGet(grpc.BidiStreamingServer[GetRequest, GetResponse]) error {
...
func _Cache_MultiSet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CacheServer).MultiSet(&grpc.GenericServerStream[SetRequest, SetResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Cache_MultiSetServer = grpc.ClientStreamingServer[SetRequest, SetResponse]

func _Cache_MultiGet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CacheServer).MultiGet(&grpc.GenericServerStream[GetRequest, GetResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Cache_MultiGetServer = grpc.BidiStreamingServer[GetRequest, GetResponse]
