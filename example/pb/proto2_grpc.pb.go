...
const (
	Proto2_Echo_FullMethodName = "/example.Proto2/Echo"
)
...
func (c *proto2Client) Echo(ctx context.Context, in *Sound2, opts ...grpc.CallOption) (*Sound2, error) {
	...
	out := new(Sound2)
	err := c.cc.Invoke(ctx, Proto2_Echo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedProto2Server must be embedded to have
...
func (UnimplementedProto2Server) testEmbeddedByValue()                {}
...
func RegisterProto2Server(s grpc.ServiceRegistrar, srv Proto2Server) {
	// If the following call pancis, it indicates UnimplementedProto2Server was
...
func _Proto2_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Proto2_Echo_FullMethodName,
	}
