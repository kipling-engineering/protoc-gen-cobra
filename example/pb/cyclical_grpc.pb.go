...
const (
	Cyclical_Test_FullMethodName = "/example.Cyclical/Test"
)
...
func (c *cyclicalClient) Test(ctx context.Context, in *Foo, opts ...grpc.CallOption) (*Bar, error) {
	...
	out := new(Bar)
	err := c.cc.Invoke(ctx, Cyclical_Test_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCyclicalServer must be embedded to have
...
func (UnimplementedCyclicalServer) testEmbeddedByValue()                  {}
...
func RegisterCyclicalServer(s grpc.ServiceRegistrar, srv CyclicalServer) {
	// If the following call pancis, it indicates UnimplementedCyclicalServer was
...
func _Cyclical_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cyclical_Test_FullMethodName,
	}
