...
func (*MapListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dabfc44e55bcc3b4, []int{0}
}
...
func (m *MapListRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MapListRequest.Merge(m, src)
}
...
func (*MapListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dabfc44e55bcc3b4, []int{1}
}
...
func (m *MapListResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MapListResponse.Merge(m, src)
}
...
func init() { proto.RegisterFile("maplist.proto", fileDescriptor_dabfc44e55bcc3b4) }

var fileDescriptor_dabfc44e55bcc3b4 = []byte{
...
// UnimplementedMapListServer can be embedded to have forward compatible implementations.
type UnimplementedMapListServer struct {
}

func (*UnimplementedMapListServer) Method(ctx context.Context, req *MapListRequest) (*MapListResponse, error) {
