...
func _TypesEchoCommand() *cobra.Command {
	...
	cmd.PersistentFlags().Var(flag.NewBoolWrapperValue(func() *wrappers.BoolValue { return req.WrapperBool }, func(v *wrappers.BoolValue) { req.WrapperBool = v }), "wrapperbool", "")
	cmd.PersistentFlags().Var(flag.NewBytesBase64WrapperValue(func() *wrappers.BytesValue { return req.WrapperBytes }, func(v *wrappers.BytesValue) { req.WrapperBytes = v }), "wrapperbytes", "")
	cmd.PersistentFlags().Var(flag.NewDoubleWrapperValue(func() *wrappers.DoubleValue { return req.WrapperDouble }, func(v *wrappers.DoubleValue) { req.WrapperDouble = v }), "wrapperdouble", "")
	cmd.PersistentFlags().Var(flag.NewDurationValue(func() *duration.Duration { return req.Duration }, func(v *duration.Duration) { req.Duration = v }), "duration", "")
	cmd.PersistentFlags().Var(flag.NewFloatWrapperValue(func() *wrappers.FloatValue { return req.WrapperFloat }, func(v *wrappers.FloatValue) { req.WrapperFloat = v }), "wrapperfloat", "")
	cmd.PersistentFlags().Var(flag.NewInt32WrapperValue(func() *wrappers.Int32Value { return req.WrapperInt32 }, func(v *wrappers.Int32Value) { req.WrapperInt32 = v }), "wrapperint32", "")
	cmd.PersistentFlags().Var(flag.NewInt64WrapperValue(func() *wrappers.Int64Value { return req.WrapperInt64 }, func(v *wrappers.Int64Value) { req.WrapperInt64 = v }), "wrapperint64", "")
	cmd.PersistentFlags().Var(flag.NewStringWrapperValue(func() *wrappers.StringValue { return req.WrapperString }, func(v *wrappers.StringValue) { req.WrapperString = v }), "wrapperstring", "")
	cmd.PersistentFlags().Var(flag.NewTimestampValue(func() *timestamp.Timestamp { return req.Timestamp }, func(v *timestamp.Timestamp) { req.Timestamp = v }), "timestamp", "")
	cmd.PersistentFlags().Var(flag.NewUInt32WrapperValue(func() *wrappers.UInt32Value { return req.WrapperUint32 }, func(v *wrappers.UInt32Value) { req.WrapperUint32 = v }), "wrapperuint32", "")
	cmd.PersistentFlags().Var(flag.NewUInt64WrapperValue(func() *wrappers.UInt64Value { return req.WrapperUint64 }, func(v *wrappers.UInt64Value) { req.WrapperUint64 = v }), "wrapperuint64", "")
